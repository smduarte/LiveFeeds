...
public class CatadupaRecentAvgTraffic extends Persistent {
	...
	public void recordNodeTraffic( CatadupaNode node ) {
		...
		slicecasting_u.tally(upTime, t.recent_slicecasting_upload_rate() );		
		slicecasting_d.tally(upTime, t.recent_slicecasting_download_rate() );
...
//		new StackedBinnedTallyDisplay("Catadupa-recDownload", catDaparture_d, dbRepair_d, casting_d, dbEndpoints_d, dbFilters_d);
		...
		DeviationBinnedTallyDisplay chart1 = new DeviationBinnedTallyDisplay(null, catDaparture_u, dbRepair_u, casting_u, slicecasting_u, dbEndpoints_u, dbFilters_u, upload) {
			protected void init() {
				super.init();
		...
		DeviationBinnedTallyDisplay chart2 = new DeviationBinnedTallyDisplay(null, catDaparture_d, dbRepair_d, casting_d, slicecasting_d, dbEndpoints_d, dbFilters_d, download) {
			protected void init() {
				super.init();
				super.setUnitsScale( 1/3600.0, 1.0) ;
