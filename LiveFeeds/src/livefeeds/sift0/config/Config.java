...
import livefeeds.sift0.ChurnModel;
import livefeeds.sift0.Main;
...
abstract public class Config extends Persistent {
	...
	public int SLICE_AGGREGATION_DEPTH = 5;
	public int JOINS_AGGREGATION_DEPTH = 8;
	public int EXITS_AGGREGATION_DEPTH = 10;
