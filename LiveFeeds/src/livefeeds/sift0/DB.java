...
//		this.deadNodes = new SlidingBitSet( 4 * 64  ); // quick and dirty to eval turmoil...
	...
	public Stamp nextStamp() {
		...
		Stamp res = new Stamp(owner.key, c_serial, p_serial, g_serial++);
	...
	public boolean store( CatadupaCastPayload m ) {
...
//		
////		System.out.println( levelOffset + ": " + ((key - levelOffset) & MAX_KEY) );
//
