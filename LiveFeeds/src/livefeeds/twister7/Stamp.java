...
public class Stamp implements Comparable<Stamp> {
	...
	final public long key ; // 16 bytes
	final public int c_serial ; // 4 bytes
	final public int p_serial ; // 4 bytes
	transient final public int g_serial = g_counter++; // not sent
