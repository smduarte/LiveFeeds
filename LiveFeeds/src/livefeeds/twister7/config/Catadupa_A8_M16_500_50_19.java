...
public class Catadupa_A8_M16_500_50_19 extends Config {

	public Catadupa_A8_M16_500_50_19() {
		Config = this;
		init();
	}
	...
	protected void init() {
		...
		MAX_SESSION_DURATION = 16 * 3600;
		MEAN_SESSION_DURATION = 8 * 3600;
	...
	public static void main(String[] args) throws Exception {
		new Catadupa_A8_M16_500_50_19().run();
	}
}
