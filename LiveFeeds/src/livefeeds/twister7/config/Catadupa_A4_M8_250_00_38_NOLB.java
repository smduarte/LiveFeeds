...
public class Catadupa_A4_M8_250_00_38_NOLB extends Config {

	public Catadupa_A4_M8_250_00_38_NOLB() {
		Config = this;
		init();
	}
	...
	protected void init() {
		...
		CATADUPA_LOAD_BALANCE_FACTOR = 10.0; // do active load balancing...
	...
	public static void main(String[] args) throws Exception {
		new Catadupa_A4_M8_250_00_38_NOLB().run();
	}
}
