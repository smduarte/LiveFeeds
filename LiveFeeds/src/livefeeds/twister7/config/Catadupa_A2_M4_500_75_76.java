...
public class Catadupa_A2_M4_500_75_76 extends Config {

	public Catadupa_A2_M4_500_75_76() {
		Config = this;
		init();
	}
	...
	protected void init() {
		...
		WEIBULL_SHAPE = 1.8;
		AVERAGE_ARRIVAL_RATE = 7.6;

		MAX_SESSION_DURATION = 4 * 3600;
		MEAN_SESSION_DURATION = 2 * 3600;
	...
	public static void main(String[] args) throws Exception {
		new Catadupa_A2_M4_500_75_76().run();
	}
}
