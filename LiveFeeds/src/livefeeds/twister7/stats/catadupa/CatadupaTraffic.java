...
public class CatadupaTraffic implements Cloneable {
	...
	public double db_upload() {
		return dbUploadEndpoints_upload + dbUploadFilters_upload + dbUploadRequest_upload ;
	}
	
	public double db_download() {
		return dbUploadEndpoints_download + dbUploadFilters_download + dbUploadRequest_download ;
	}
	...
	public double upload() {
		return repair_upload() + db_upload() + casting_upload() + 0*departure_upload();
	}
	
	public double download() {
		return repair_download() + db_download() + casting_download() + 0*departure_download();
	}
