...
public class DB {
	...
	protected DB(CatadupaNode owner) {
		...
		this.deadNodes = new SlidingBitSet( (int)(Config.AVERAGE_ARRIVAL_RATE * Config.MEAN_SESSION_DURATION/2) );
	...
	void store(Collection<Integer> failed) {		
		for( int i : failed) 
			deadNodes.set(i);
	}
