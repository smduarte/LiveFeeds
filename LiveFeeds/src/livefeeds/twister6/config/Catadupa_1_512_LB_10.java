...
public class Catadupa_1_512_LB_10 extends Config {

	public Catadupa_1_512_LB_10() {
		Config = this ;
		init() ;
	}
	...
	protected void init() {
		...
		FILTER_KEY_SIZE = 16 ; // filter hash
		FILTER_DATA_SIZE = 512;
...
//		CATADUPA_LOAD_BALANCE_FACTOR = 1e10 ; // no active load balancing...
		CATADUPA_LOAD_BALANCE_FACTOR = 0.95 ; // do active load balancing...
