...
public class Catadupa_2_0 extends Config {
	...
	protected void init() {
		...
		DB_FILTER_DOWNLOAD_SPAN = 5 * 60 ;

		CATADUPA_LOAD_BALANCE_FACTOR = 1e10 ; // no active load balancing...
//		CATADUPA_LOAD_BALANCE_FACTOR = 1.15 ; // do active load balancing...
		...
		DbUploadAccept.accountTraffic = false ;
		DbUploadReject.accountTraffic = false ;
		DbUploadFilters.accountTraffic = false ;
		DbUploadEndpoints.accountTraffic = false ;
		DbUploadFiltersRequest.accountTraffic = false;
		DbUploadEndpointsRequest.accountTraffic = false ;
		
		DbRepairReply.accountTraffic = false ;
		DbRepairRequest.accountTraffic = false ;
		
		Globals.set("NoGUI", true);
	}
	
	public static void main( String[] args) throws Exception {
		new Catadupa_2_0().run() ;
	}
}
