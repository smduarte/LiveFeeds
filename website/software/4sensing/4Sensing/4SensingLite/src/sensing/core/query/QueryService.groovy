...
public abstract class QueryService extends Service {
	...
	static {
//smd		queryImpl[ServicesConfig.QueryImplPolicy.QUAD_TREE] = sensing.core.query.quadtree.QTQueryService.class;
//		queryImpl[ServicesConfig.QueryImplPolicy.RND_TREE]  = sensing.core.query.rndtree.RTQueryService.class;
//		queryImpl[ServicesConfig.QueryImplPolicy.NEAREST_TREE]  = sensing.core.query.ntree.NTQueryService.class;
		queryImpl[ServicesConfig.QueryImplPolicy.CENTRALIZED]  = sensing.core.query.centralized.CQueryService.class;
	}
	...
	public static QueryService newQueryService(ServiceManager services, ServicesConfig.QueryImplPolicy policy) {
		return queryImpl[policy].newInstance(services);
	}
...
//smd				services.logging.log(DEBUG, this, "setupSensorInput", "got $reading - eval: $queryeval - aoi: ${qc.query.aoi}");
