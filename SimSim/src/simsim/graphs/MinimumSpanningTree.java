 ...
 * @param <T>
 */
public class MinimumSpanningTree<T extends Comparable<T>> extends SpanningTree<T> {
        
    /**
     * @param nc - Collection of nodes of the graph.
     * @param ec - Collection of edges of the graph.
     */
    public MinimumSpanningTree( Collection<T> nc, Collection<? extends Link<T>> ec ) {
    ...
    //-------------------------------------------------------------------------------------------
    //-------------------------------------------------------------------------------------------
    private void calcTree( Collection<T> nc, Collection<? extends Link<T>> ne ) {
